...
Остановлен при помощи 
```sh ./scripts/stop.sh```

Проект поднимает структуру из двух контейнеров коммуницирующих друг с другом по портам :8000 для бэкенда и :3000 для фронтенда
Перейти к просмотру приложения можно по адресу http://localhost:3000/, архитектуру бэкенда http://localhost:8000/docs

Перейдя к просмотру сайта, пользователь видит панель управления настройками обучения моделей, а так же настройкой датасета
